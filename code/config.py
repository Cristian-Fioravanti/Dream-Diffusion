...
class Config_EEG_finetune:
    def __init__(self):
        ...
        self.splits_path = os.path.join(
            self.root_path, "datasets/block_splits_by_image_all.pth"
        )
...
class Config_Cls_Model:
    def __init__(self):
        ...
        self.eeg_signals_path = os.path.join(
            self.root_path, "datasets/eeg_14_70_std.pth"
        )
