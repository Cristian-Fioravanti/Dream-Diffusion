...
class NativeScalerWithGradNormCount:
    ...
    def __call__(
        ...
        )  # Poiché i gradienti sono stati scalati durante il forward pass, il backward pass si basa su questi gradienti scalati. In sostanza, è qui che i gradienti vengono effettivamente calcolati e modificati
        if update_grad:
            ...
            self._scaler.step(
                optimizer
            )  # esegue l'aggiornamento degli ottimizzatori applicando gli step del gradiente scalati
